...
public struct ActionRequest : IEquatable<ActionRequest> {
    ...
    public static ActionRequest CreateTrain(int spawnProtoId) {
        return new ActionRequest(ActionTypes.None) {
            ActionId = OrderTrainSystem.Identifier,
            TargetLocation = spawnProtoId,
        };
    }
}
